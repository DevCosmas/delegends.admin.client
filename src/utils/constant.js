...
const MY_NUMBER = '0811713529';

const AGRO_HERO_WORD = `Allow our agro product to the do work and see 50% increase in
your agro produce. All Agro product are organically made, safe
for humans, animal and the environment`;

const HEALTH_HERO_WORD = `Stop being reactive to your health. Be Proactive today with our
